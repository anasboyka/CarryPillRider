                      ...
                      Align(
                        ...
                        child: MaterialButton(
                          ...
                          child: Text(
                            'Browse file',
                            style:
                                kwtextStyleRD(fs: 14, fw: kfbold, c: kcWhite),
                          ),
                        ),
                      ),
                      gaphr(h: Platform.isAndroid ? 290 : 200.h),
                      MaterialButton(
                            ...
                            if (file != null) {
                              ...
                              if (url != null) {
                                Vehicle vehicle = Vehicle(
                                  riderLicense: url,
                                  vehiclePlateNum:
                                      plateNumCon.text.toUpperCase(),
                                  vehicleBrand:
                                      vehicleBrandCon.text.toUpperCase(),
                                );
                                await FirestoreRepo(
                                        uid: widget.rider.documentID)
